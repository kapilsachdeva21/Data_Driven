...
public class TestConfig{
	...
	public static String from = "contact13585@gmail.com";
	public static String password = "xyz@123";
	public static String[] to ={"seleniumcoaching@gmail.com","contact13585@gmail.com"};
